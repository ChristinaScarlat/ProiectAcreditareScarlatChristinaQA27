...
public class SearchSteps extends BaseSteps{
    ...
    public void findProductWithNameInListAndOpen(String productName){
       Assert.assertEquals(true,searchResultsPage.findProductInGridAndOpen(productName));
    }
    ...
    public void findProductWithInvalidName(){
        Assert.assertEquals("No products were found matching your selection.",searchResultsPage.getSearchForInvalidProduct());
    }
}
